    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div id="chart-container">
                <canvas id="mycanvas" height="500" width="1100">
...
<!-- page script -->
<script type="text/javascript" src="css/plugins/jQuery/jquery-2.2.3.min.js"></script>
<script type="text/javascript" src="css/plugins/chartjs/Chart.min.js"></script>
<script type="text/javascript" src="css/plugins/chartjs/Chart.js"></script>
<script type="text/javascript" src="css/plugins/app.js"></script>
</body>
</html>
