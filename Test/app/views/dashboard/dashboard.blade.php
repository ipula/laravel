                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{Auth::user()->employeename}} - {{Auth::user()->email}}
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    ...
                                    {{--{{HTML::link('profile','Profile',array('class'=>'btn btn-default btn-flat'))}}--}}
                                </div>
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <!-- chat item -->
                            <div class="item">
                                <img src="css/dist/img/user2-160x160.jpg" alt="user image" class="online">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="css/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="css/dist/img/user2-160x160.jpg" alt="user image" class="offline">
